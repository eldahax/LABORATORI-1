...
router.get( "/:id", protect,authorize("patient", "admin","doctor"), appointmentController.getById);
router.put( "/:id", protect,authorize("patient", "admin","receptionist","doctor"), appointmentController.update);
