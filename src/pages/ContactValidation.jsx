...
export default function Contact() {
    ...
    return (
        <div className="flex justify-center items-center w-full min-h-screen font-serif">
            <div className="w-full max-w-md p-8 rounded-3xl shadow-xl bg-white border border-gray-200">
