  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 w-full">
      ...
      <div className="flex justify-between pt-6 max-[500px]:flex-col max-[500px]:gap-3">
        <button
          type="button"
          className="border border-gray-400 text-gray-700 px-8 py-3 rounded-lg w-[48%] max-[500px]:w-full"
        >
          Discard
        </button>
        ...
        <button
          type="submit"
          className="bg-teal-700 text-white px-8 py-3 rounded-lg w-[48%] max-[500px]:w-full"
        >
          Save Changes
        </button>
      </div>
