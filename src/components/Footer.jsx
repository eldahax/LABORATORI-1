...
const Footer = () => {
    return (
        <footer className="bg-white shadow-2xl shadow-gray-500 text-gray-900 mt-10 p-10">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                <div>
                    <h4 className="text-xl font-bold mb-4">Support</h4>
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-green-600 transition">FAQs</a></li>
                        <li><a href="#" className="hover:text-green-600 transition">Appointments</a></li>
                ...
                <div>
                    ...
                    <p className="mb-2">Email us for updates & offers</p>
                    ...
                    <div className="flex justify-center md:justify-start space-x-4 mt-4">
                        <a href="https://facebook.com" target="_blank" className="hover:opacity-80 transition">
                            <img src={img1} alt="Facebook" className="w-7 h-7" />
                        </a>
                        <a href="https://tiktok.com" target="_blank" className="hover:opacity-80 transition">
                            <img src={img2} alt="Instagram" className="w-7 h-7" />
                        </a>
                        <a href="https://instagram.com" target="_blank" className="hover:opacity-80 transition">
                            <img src={img3} alt="tiktok" className="w-7 h-7" />
                        </a>
                    </div>
                </div>
            ...
            <div className="mt-10 text-center border-t border-[#0F766E] border-t-2 pt-4 text-gray-600">
